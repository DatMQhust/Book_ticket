...
export class UpdateEventSession1762099846778 implements MigrationInterface {
  ...
  ( ("eventId" IS NULL) AND ("eventSessionId" IS NOT NULL) )
    ...
    await queryRunner.query(
      `ALTER TABLE "event_sessions" ADD CONSTRAINT "FK_51ed83c9a1acb790e7d51f1358a" FOREIGN KEY ("eventId") REFERENCES "events"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "ticket-types" ADD CONSTRAINT "FK_acb9279eaaa5afcd9acc1b78b03" FOREIGN KEY ("eventSessionId") REFERENCES "event_sessions"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "ticket-types" DROP CONSTRAINT "FK_acb9279eaaa5afcd9acc1b78b03"`,
    );
    await queryRunner.query(
      `ALTER TABLE "event_sessions" DROP CONSTRAINT "FK_51ed83c9a1acb790e7d51f1358a"`,
    );
    await queryRunner.query(
      `ALTER TABLE "ticket-types" DROP CONSTRAINT "CHK_4df9ac3884cf9acfdfd7bdca4c"`,
    );
    await queryRunner.query(
      `ALTER TABLE "ticket-types" DROP COLUMN "eventSessionId"`,
    );
